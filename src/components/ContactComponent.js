        ...
        <div className="row">
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-4 offset-sm-1" >
                      ...
                      <i className="fa fa-phone fa-lg"></i>: +91 9123945220<br />
                      <i className="fa fa-envelope fa-lg"></i>: <a href="mailto:krishisahyog@agri.net">
                            krishisahyog@agri.net</a>
                    </address>
                </div>
            
                <div className="col-12 col-sm-11 offset-sm-1">
                    <div className="btn-group" role="group">
                        <a role="button" className="btn btn-primary" href="tel:+91 9123945220"><i className="fa fa-phone"></i> Call</a>
                        <a role="button" className="btn btn-success" href="mailto:krishisahyog@agri.net"><i className="fa fa-envelope-o"></i> Email</a>
                    </div>
                </div>
            </div>
            <div className="row row-content">
